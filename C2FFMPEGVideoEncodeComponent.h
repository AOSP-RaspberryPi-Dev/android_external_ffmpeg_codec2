...
#ifndef C2_FFMPEG_VIDEO_ENCODE_COMPONENT_H
#define C2_FFMPEG_VIDEO_ENCODE_COMPONENT_H
...
class C2FFMPEGVideoEncodeComponent : public SimpleC2Component {
public:
    explicit C2FFMPEGVideoEncodeComponent(
        const C2FFMPEGComponentInfo* componentInfo,
        const std::shared_ptr<C2FFMPEGVideoEncodeInterface>& intf);
    virtual ~C2FFMPEGVideoEncodeComponent();
...
private:
    ...
    std::shared_ptr<C2FFMPEGVideoEncodeInterface> mIntf;
...
#endif // C2_FFMPEG_VIDEO_ENCODE_COMPONENT_H
