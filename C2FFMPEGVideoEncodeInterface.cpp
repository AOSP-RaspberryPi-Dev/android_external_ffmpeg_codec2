...
#define LOG_TAG "C2FFMPEGVideoEncodeInterface"
...
C2FFMPEGVideoEncodeInterface::C2FFMPEGVideoEncodeInterface(
...
C2R C2FFMPEGVideoEncodeInterface::SizeSetter(
        bool /* mayBlock */,
...
C2R C2FFMPEGVideoEncodeInterface::ProfileLevelSetter(
        bool /* mayBlock */,
