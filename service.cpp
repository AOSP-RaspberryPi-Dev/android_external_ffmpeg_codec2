...
public:
    ...
    virtual std::vector<std::shared_ptr<const C2Component::Traits>>
        ...
        uint32_t defaultRank = ::android::base::GetUintProperty("vendor.ffmpeg_codec2.rank", 0x110u);
        uint32_t defaultRankAudio = ::android::base::GetUintProperty("vendor.ffmpeg_codec2.rank.audio", defaultRank);
        uint32_t defaultRankVideo = ::android::base::GetUintProperty("vendor.ffmpeg_codec2.rank.video", defaultRank);
