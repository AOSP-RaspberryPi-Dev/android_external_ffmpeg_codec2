...
#ifndef C2_FFMPEG_VIDEO_ENCODE_INTERFACE_H
#define C2_FFMPEG_VIDEO_ENCODE_INTERFACE_H
...
class C2FFMPEGVideoEncodeInterface : public SimpleInterface<void>::BaseParams {
public:
    explicit C2FFMPEGVideoEncodeInterface(
...
#endif // C2_FFMPEG_VIDEO_ENCODE_INTERFACE_H
